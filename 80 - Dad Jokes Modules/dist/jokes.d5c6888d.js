...
// Named exports we can have a lot of these
async function fetchJoke(loader) {
  ...
  const data = await response.json(); // turn the loader off
...
const buttonText = ['Ugh.', '🤦🏻‍♂️', 'omg dad.', 'you are the worst', 'seriously', 'stop it.', 'please stop', 'that was the worst one']; // default export, only one per file
...
async function handleClick() {
  ...
  _elements.jokeHolder.textContent = joke; // chaging button
...
_elements.jokeButton.addEventListener('click', () => (0, _handlers.handleClick)());
