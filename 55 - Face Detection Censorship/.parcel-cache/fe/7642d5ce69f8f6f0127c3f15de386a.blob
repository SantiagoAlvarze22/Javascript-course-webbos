...
const SIZE = 10;
const SCALE = 1.5; // creating a new face detector
...
function censor({
  ...
  face.x, face.y, SIZE, SIZE); // take that face back out and draw it back at normal size
  // DRAW the small face back on, but scale up

  faceCtx.drawImage(faceCanvas, // source
  face.x, // where do we start the source pull from?
  face.y, SIZE, SIZE, // Drawingn arguments
...
//# sourceMappingURL=pixelated-face.60bf276b.js.map
