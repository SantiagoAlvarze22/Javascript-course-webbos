...
})({"e120c45f26099db990889e3fc16d74b4":[function(require,module,exports) {
...
optionsInput.forEach(input => input.addEventListener('input', handleOption)); // creating a new face detector
...
function censor({
  ...
  faceCtx.imageSmoothingEnabled = false; // para limpiarlo cada vez que se lea una cara
  ...
  face.x, face.y, options.SIZE, options.SIZE); // take that face back out and draw it back at normal size
  // DRAW the small face back on, but scale up

  faceCtx.drawImage(faceCanvas, // source
  face.x, // where do we start the source pull from?
  face.y, options.SIZE, options.SIZE, // Drawingn arguments
  face.x - (width - face.width) / 2, face.y - (width - face.height) / 2, width, height);
}
...
},{}]},{},["13ce80ed9a2051f997528b96cdd8e3d2","e120c45f26099db990889e3fc16d74b4"], null)

//# sourceMappingURL=pixelated-face.6143534b.js.map
